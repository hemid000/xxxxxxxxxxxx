...
function Listdata1({scrollToBack, setBackactive  }) {
      ...
      <div className="mini">
        <div className="data">
          ...
          <div className="main">
            ...
            Vebsaytın hazırlanmasına strateji planlaşdırma, məzmunun təşkili, dizayn və inkişaf, platforma seçimi, domen əldə edilməsi, SEO inteqrasiyası, hərtərəfli sınaq, əlaqələndirilmiş işə salınma, analitika ilə davamlı monitorinq, müntəzəm yeniləmələr və effektiv onlayn mövcudluq üçün istifadəçi rəyi əsasında təkrarlanan təkmilləşdirmələr daxildir.
            </p>
          </div>
