...
function Listdata4({scrollToBack, setBackactive }) {
      ...
      <div className="mini">
        <div className="data">
          ...
          <div className="main">
            ...
            Veb sayt dizaynında keyfiyyət təhlili İstifadəçi təcrübəsinin subyektiv aspektlərinin qiymətləndirilməsini əhatə edir. Buraya sorğular və müsahibələr vasitəsilə İstifadəçi rəyinin toplanması, istifadəyə yararlılıq testlərinin aparılması, istilik xəritələri kimi analitik vasitələrdən istifadə və vizual cəlbediciliyin qiymətləndirilməsi daxildir. Keyfiyyətli anlayışlar dizaynerlərə istifadəçi emosiyalarını, üstünlüklərini və çətinliklərini başa düşməyə kömək edir, daha çox istifadəçi mərkəzli və cəlbedici veb-sayt dizaynlarına gətirib çıxarır.
            </p>
          </div>
